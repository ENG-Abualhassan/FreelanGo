  ...
  <section class="register-section">
        <div class="register-container">
            <div class="register-form-container">
                ...
                <form id="registerForm" enctype="multipart/form-data" method="POST" action="{{ route("$guard".".register.submit") }}">
                @csrf    
                        ...
                        <div class="form-step active" id="step1">
                            <div class="form-group">
                                ...
                                <div class="account-type">
                                    <input type="radio" name="accountType" id="client" value="web" checked>
                                    <label for="client">
                                    ...
                                    <input type="radio" name="accountType" id="freelancer" value="freelancers">
                        ...
                        <div class="form-step" id="step2">
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="name" id="fullname" class="form-control" placeholder="ادخل اسمك الكامل"
                                        required>
                                </div>
                            </div>
